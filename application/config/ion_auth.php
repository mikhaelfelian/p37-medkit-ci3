...
*/
$config['tables']['users']           = 'tbl_ion_users';
$config['tables']['groups']          = 'tbl_ion_groups';
$config['tables']['users_groups']    = 'tbl_ion_users_groups';
$config['tables']['login_attempts']  = 'tbl_ion_login_attempts';
$config['tables']['modules']         = 'tbl_ion_modules';
 ...
 */
$config['site_title']                 = "Medkit";       		// Site Title, example.com
$config['admin_email']                = "admin@example.com"; 	// Admin Email, admin@example.com
$config['default_group']              = 'kasir';           	// Default group, use name
$config['admin_group']                = 'root';             	// Default administrators group, use name
 ...
 */
$config['remember_cookie_name'] = 'GeTMedkit_RemCode';
