                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">BERKAS - <?php echo $sql_pasien->nama_pgl; ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <div
                                        class="form-group row <?php echo (!empty($hasError['judul']) ? 'text-danger' : '') ?>">
                                    ...
                                    <div
                                        class="form-group row <?php echo (!empty($hasError['keterangan']) ? 'text-danger' : '') ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <a class="btn btn-primary btn-flat"
                                        href="<?php echo base_url((isset($_GET['route']) ? $this->input->get('route') : 'medcheck/tindakan.php') . '?id=' . general::enkrip($sql_medc->id)) ?>">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($sql_medc_file as $file) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        <?php echo $this->tanggalan->tgl_indo5($file->tgl_masuk); ?></td>
                                                    <td class="text-left">
                                                        <?php if ($is_image == 'image') { ?>
                                                            <a href="<?php echo $filename ?>" data-toggle="lightbox"
                                                                data-title="<?php echo strtolower($file->judul . ' - ' . $sql_pasien->nama_pgl) ?>">
                                                    ...
                                                    <td class="text-left">
                                                        <?php if (empty($file->id_berkas) || $file->id_berkas == null || $file->id_berkas == 0): ?>
