<?php echo form_open_multipart(base_url('medcheck/set_medcheck_lab_ekg_upload.php'), 'autocomplete="off"') ?>
...
<div class="card">
        ...
        <div class="row">
            <div class="col-md-6">                    
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <?php echo form_input(array('id' => 'item_value', 'name' => 'judul', 'class' => 'form-control rounded-0 pull-left', 'placeholder' => 'Isikan Judul ...')) ?>
                    </div>
                </div>
                <div class="form-group row">
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-lg-6">
                <button type="button" class="btn btn-primary btn-flat" onclick="window.location.href = '<?php echo base_url(!empty($_GET['route']) ? $this->input->get('route') : 'medcheck/tambah.php?act=pen_ekg&id=' . $this->input->get('id') . '&status=' . $this->input->get('status')) ?>'"><i class="fas fa-arrow-left"></i> Kembali</button>
            </div>
