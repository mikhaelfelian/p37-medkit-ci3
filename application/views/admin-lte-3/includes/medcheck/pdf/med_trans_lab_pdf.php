...
<table>
    <thead>
        <tr>
            <th width="40%" style="border-top: 1px solid #000; font-weight: bold; text-align: left; font-family: helvetica; font-size: 9pt;">PEMERIKSAAN</th>
            <th width="20%" style="border-top: 1px solid #000; font-weight: bold; text-align: left; font-family: helvetica; font-size: 9pt;">HASIL</th>
            <th width="20%" style="border-top: 1px solid #000; font-weight: bold; text-align: left; font-family: helvetica; font-size: 9pt;">NILAI RUJUKAN</th>
            <th width="20%" style="border-top: 1px solid #000; font-weight: bold; text-align: left; font-family: helvetica; font-size: 9pt;">SATUAN</th>
        </tr>
        <tr>
            <th width="40%" style="border-bottom: 1px solid #000; font-weight: bold; font-style: italic; text-align: left; font-family: helvetica; font-size: 9pt;">EXAMINATION</th>
            <th width="20%" style="border-bottom: 1px solid #000; font-weight: bold; font-style: italic; text-align: left; font-family: helvetica; font-size: 9pt;">RESULT</th>
            <th width="20%" style="border-bottom: 1px solid #000; font-weight: bold; font-style: italic; text-align: left; font-family: helvetica; font-size: 9pt;">REFERENCE VALUE</th>
            <th width="20%" style="border-bottom: 1px solid #000; font-weight: bold; font-style: italic; text-align: left; font-family: helvetica; font-size: 9pt;">MEASURE</th>
        </tr>
    </thead>
    <tbody>
        <?php $no = 1;
    ...
    <div style="margin-top: 10px;">
        ...
        <div style="font-size: 8pt; margin-left: 10px;">
            <p>1. Hasil positiv berlaku untuk hasil PCR SARS CoV-2 atau Antigen dari Laboratorium Klinik Utama Rawat Inap 
               ...
               laboratorium lain.</p>
            <p style="font-style: italic;">Positive results apply to PCR results for SARS CoV-2 or Antigens from the Esensia Inpatient Main
            ...
            <p style="font-style: italic;">A negative results does not necessarily mean that the patient is not infected with SARS-CoV-2, and
