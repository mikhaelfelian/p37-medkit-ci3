                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div
                                    class="form-group <?php echo (!empty($hasError['jns_klm']) ? 'text-danger' : '') ?>">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div
                                            class="form-group <?php echo (!empty($hasError['nik']) ? 'text-danger' : '') ?>">
                                        ...
                                        <section id="pasien_lama">
                                            <div
                                                class="form-group <?php // echo (!empty($hasError['no_rm']) ? 'text-danger' : '')                   ?>">
                                                <label class="control-label">No RM* <small><i>(* Nomor Rekam
                                                            Medis)</i></small></label>
                                        ...
                                        <section id="pasien_baru1">
                                            <div class="row">
                                                <div class="col-3">
                                                    <div
                                                        ...
                                                        <select name="gelar"
                                                            class="form-control <?php echo (!empty($hasError['gelar']) ? 'is-invalid' : '') ?>"
                                                            readonly="TRUE">
                                            ...
                                            <div
                                                class="form-group <?php echo (!empty($hasError['tmp_lahir']) ? 'has-error' : '') ?>">
                                            ...
                                            <div
                                                class="form-group <?php echo (!empty($hasError['nama']) ? 'has-error' : '') ?>">
                                    ...
                                    <div class="col-md-6">
                                        <section id="pasien_baru2">
                                            <div
                                                class="form-group <?php echo (!empty($hasError['nik']) ? 'has-error' : '') ?>">
                                                <label class="control-label">Alamat <small><i>* Sesuai
                                            ...
                                            <div
                                                ...
                                                <select name="pekerjaan" class="form-control" readonly="TRUE">
                                                    ...
                                                    <?php foreach ($kerja as $kerja) { ?>
                                                        <option value="<?php echo $kerja->id ?>" <?php echo ($kerja->id == $sql_dft_id->id_pekerjaan ? 'selected' : '') ?>>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div
                                            ...
                                            <select name="poli"
                                                class="form-control <?php echo (!empty($hasError['poli']) ? ' is-invalid' : '') ?>"
                                                readonly="TRUE">
                                                <option value="">- Poli -</option>
                                                <?php foreach ($poli as $poli) { ?>
                                                    <option value="<?php echo $poli->id ?>" <?php echo ($poli->id == $sql_dft_id->id_poli ? 'selected' : '') ?>>
                                                        <?php echo $poli->lokasi ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div
                                            class="form-group <?php echo (!empty($hasError['dokter']) ? 'text-danger' : '') ?>">
                                            <label class="control-label">Dokter</label>
                                            <select name="dokter"
                                                class="form-control <?php echo (!empty($hasError['dokter']) ? ' is-invalid' : '') ?>"
                                                readonly="TRUE">
                                                <option value="">- Dokter -</option>
                                                <?php foreach ($sql_doc as $doctor) { ?>
                                                    <option value="<?php echo $doctor->id_user ?>" <?php echo ($doctor->id_user == $sql_dft_id->id_dokter ? 'selected' : '') ?>>
