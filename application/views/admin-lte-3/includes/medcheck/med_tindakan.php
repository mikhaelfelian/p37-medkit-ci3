                ...
                <div class="col-lg-8">
                    ...
                    <div class="card rounded-0">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $sql_pasien->nama_pgl; ?>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($sql_medc_det as $det) { ?>
                                                        ...
                                                        <?php foreach ($sql_det as $medc) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-left">
                                                                    <?php echo $this->tanggalan->tgl_indo5($medc->tgl_simpan); ?>
                                                                </td>
                                                                <td class="text-left">
                                                                    <?php echo $medc->item; ?>
                                                                    <?php if ($medc->nama != '-') { ?>
                                                                ...
                                                                <td class="text-right">
                                                                    <?php echo general::format_angka($medc->harga); ?></td>
                                                                <td class="text-right">
                                                                    <?php echo general::format_angka($item_subtotal); ?></td>
                                                            </tr>
                                                                ...
                                                                <?php foreach ($sql_rf->result() as $reff) { ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-left"><small>-
                                                                                <i><?php echo $reff->item ?></i></small></td>
                                                                        <td class="text-center">
                                                                            <small><i><?php echo (float) $reff->jml ?></i></small></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right text-bold" colspan="5">
                                                                <?php echo general::format_angka($sub); ?></td>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right text-bold" colspan="5">
                                                            <?php echo general::format_angka($gtotal, 2); ?></td>
                                                    </tr>
                                                    ...
                                                    <?php foreach ($sql_tpp->result() as $tpp) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right text-bold" colspan="5">
                                                                <?php echo general::format_angka($tpp->nominal, 2); ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
