                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (akses::hakSA() == TRUE || akses::hakOwner() == TRUE || akses::hakAdminM() == TRUE || akses::hakAdmin() == TRUE || akses::hakFarmasi() == TRUE) { ?>
                                                        <?php echo anchor(base_url('master/data_barang_tambah.php?page=master&act=cek_satuan&id=' . general::enkrip($barang->id)), '<i class="fas fa-edit"></i> Ubah', 'class="btn btn-info btn-flat btn-xs" style="width: 55px;"') ?>
