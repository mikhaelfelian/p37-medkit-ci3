            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="small-box bg-info">
                        <div class="inner">
                            <?php
                            $total_penjualan = $this->db->where('status_pos', '2')
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                if ($sales['total'] > 0) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">Rp
                                                            <?php echo number_format($sales['total'], 0, ',', '.'); ?></td>
                                                        <td>
                                                            <?php if ($no == 2): ?>
                                            ...
                                            if ($no == 1) {
                                                ?>
                                                <tr>
                                                    <td colspan="4" class="text-center">Tidak ada data penjualan untuk tahun
                                        ...
                                        if (!empty($best_sellers)) {
                                            foreach ($best_sellers as $product) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <?php echo number_format($product->total_sold, 0, ',', '.'); ?></td>
                                                </tr>
                                            <?php
                                            }
                                        } else {
