...
) ENGINE=InnoDB AUTO_INCREMENT=704290 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=27557 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `tbl_trans_mutasi` (
  ...
  PRIMARY KEY (`id`),
  KEY `no_nota` (`no_nota`)
) ENGINE=InnoDB AUTO_INCREMENT=672 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Mencatat transaksi mutasi antar gudang';
...
) ENGINE=InnoDB AUTO_INCREMENT=23694 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Mencatat transaksi mutasi antar gudang';
